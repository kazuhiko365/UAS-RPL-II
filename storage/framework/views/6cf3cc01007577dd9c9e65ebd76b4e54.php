...
$message = $__bag->first($__errorArgs[0]); ?> <p class="text-red-500 text-xs mt-1 font-semibold ml-1"><?php echo e($message); ?></p> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <select id="venue_id" name="venue_id" class="appearance-none w-full bg-gray-50 border border-gray-200 text-gray-900 text-sm rounded-xl focus:ring-emerald-500 focus:border-emerald-500 block px-4 py-3.5 transition cursor-pointer font-medium">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea id="description" name="description" rows="3" class="w-full bg-gray-50 border border-gray-200 text-gray-900 text-sm rounded-xl focus:ring-emerald-500 focus:border-emerald-500 block px-4 py-3 transition placeholder-gray-400 font-medium" placeholder="Tulis info penting: bawa raket sendiri, patungan di lokasi, level pemula welcome, dll."><?php echo e(old('description', request('description') ?? '')); ?></textarea>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Laravel\reclub-app\resources\views/rooms/create.blade.php ENDPATH**/ ?>