...
<head>
    ...
    <title>SportClub - Cari Teman Mabar</title>
    ...
    <nav class="absolute top-0 w-full z-50 px-6 py-6 flex justify-between items-center">
        ...
        <div class="space-x-3 md:space-x-6">
            <?php if(auth()->guard()->check()): ?>
                <a href="<?php echo e(route('home')); ?>" class="text-white font-bold hover:text-emerald-400 transition text-sm md:text-base">Dashboard</a>
            <?php else: ?>
                <a href="<?php echo e(route('login')); ?>" class="text-white font-medium hover:text-emerald-300 transition text-sm md:text-base">Masuk</a>
                <a href="<?php echo e(route('register')); ?>" class="bg-white text-emerald-900 px-4 py-2 rounded-full font-bold hover:bg-emerald-50 transition shadow-lg text-xs md:text-sm">Daftar Sekarang</a>
            <?php endif; ?>
        </div>
    </nav>
    ...
    <div class="relative w-full min-h-screen hero-bg flex flex-col justify-center pt-32 pb-12">
        ...
        <div class="relative z-10 px-6 md:px-12 lg:px-24 w-full max-w-7xl">
            ...
            <div class="flex flex-wrap gap-4">
                <a href="<?php echo e(route('home')); ?>" class="px-6 py-3 md:px-8 md:py-4 bg-emerald-600 hover:bg-emerald-700 text-white rounded-2xl font-bold text-sm md:text-lg transition transform hover:-translate-y-1 shadow-emerald-500/30 shadow-lg flex items-center justify-center gap-2">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg>
                    Cari Lapangan
                </a>
                <a href="<?php echo e(route('register')); ?>" class="px-6 py-3 md:px-8 md:py-4 bg-white/10 backdrop-blur-md border border-white/20 hover:bg-white/20 text-white rounded-2xl font-bold text-sm md:text-lg transition flex items-center justify-center gap-2">
                    Buat Room
                </a>
            </div>
...
</html><?php /**PATH C:\Laravel\reclub-app\resources\views/landing.blade.php ENDPATH**/ ?>