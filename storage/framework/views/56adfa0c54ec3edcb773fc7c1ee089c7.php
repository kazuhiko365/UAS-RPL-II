...
<body>
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <p style="margin-bottom: 20px;">Permintaan join kamu telah <strong>DIKONFIRMASI</strong> oleh Host. Siapkan sepatumu, kita main!</p>

            <div class="card">
                <div style="text-align: center; font-weight: bold; margin-bottom: 15px; color: #047857; text-transform: uppercase; font-size: 12px;">
                    Detail Tiket Masuk
                </div>
                ...
                <div class="card-row">
                    ...
                    <div class="value">Rp <?php echo e(number_format($participant->room->cost_per_person, 0, ',', '.')); ?> / orang</div>
                </div>
            </div>
...
</html><?php /**PATH C:\Laravel\reclub-app\resources\views/emails/join_confirmed.blade.php ENDPATH**/ ?>