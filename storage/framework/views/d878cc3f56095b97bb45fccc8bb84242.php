...
<?php $__env->startSection('content'); ?>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-8">
            ...
            <form action="<?php echo e(route('cari.mabar')); ?>" method="GET">
                    ...
                    <div class="md:col-span-3">
                        ...
                        <select name="sport_id"
                            ...
                            <?php $__currentLoopData = $sports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($s->id); ?>" <?php echo e(request('sport_id') == $s->id ? 'selected' : ''); ?>><?php echo e($s->name); ?>
        ...
        <div class="space-y-6">
            <div class="flex justify-between items-center">
                ...
                <span class="bg-emerald-100 text-emerald-800 text-xs font-bold px-3 py-1 rounded-full"><?php echo e(count($venues)); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <?php $__empty_1 = true; $__currentLoopData = $venues; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $venue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div
                        ...
                        <div class="flex-grow">
                            <p class="text-xs text-gray-400 mb-4 line-clamp-2"><?php echo e($venue->address); ?></p>

                            <!-- Preview Rooms info -->
                            <?php if($venue->rooms->count() > 0): ?>
                                <div class="bg-gray-50 rounded-lg p-3 text-xs text-gray-600">
                                    <span class="font-bold block mb-1">Room Tersedia:</span>
                                    <ul class="space-y-1">
                                        <?php $__currentLoopData = $venue->rooms->where('is_active', true)->where('start_datetime', '>=', now())->take(2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $room): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li class="truncate flex items-center gap-1">
                                                <span class="w-1.5 h-1.5 rounded-full bg-emerald-500 inline-block"></span>
                                                <?php echo e($room->title); ?> -
                                                <?php echo e(\Carbon\Carbon::parse($room->start_datetime)->format('d M H:i')); ?>
                                        ...
                                        ?>
                                        <?php if($remaining > 0): ?>
                                            <li class="text-emerald-600 font-bold pl-2.5">+ <?php echo e($remaining); ?> lainnya</li>
                                        <?php endif; ?>
                                    </ul>
                                </div>
                            <?php else: ?>
                        ...
                        <a href="<?php echo e(route('venues.rooms', $venue->id)); ?>" class="mt-4 block w-full text-center bg-white border-2 border-emerald-600 text-emerald-600 hover:bg-emerald-600 hover:text-white py-2.5 rounded-xl font-bold transition">
                            Lihat Semua Room
                        </a>
                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\INFORMATIKA RASTRA\Smt 5\PTI\reclub-app\resources\views/venues/browse_rooms.blade.php ENDPATH**/ ?>