    ...
    <div class="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden">
        ...
        <div class="px-8 py-10 bg-gradient-to-br from-emerald-600 to-teal-700 text-white relative overflow-hidden">
            ...
            <div class="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                ...
                <a href="{{ route('rooms.show', $room) }}" class="group flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-white/20 px-5 py-2.5 rounded-2xl font-bold text-sm hover:bg-white/20 transition shadow-sm">
                ...
                <div class="mb-10">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="title" value="{{ old('title', $room->title) }}" class="w-full bg-gray-50 border border-gray-200 text-gray-900 text-sm rounded-xl focus:ring-emerald-500 focus:border-emerald-500 block px-4 py-3.5 transition font-medium" required>
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="description" rows="3" class="w-full bg-gray-50 border border-gray-200 text-gray-900 text-sm rounded-xl focus:ring-emerald-500 focus:border-emerald-500 block px-4 py-3 transition font-medium">{{ old('description', $room->description) }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-10">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div>
                            ...
                            <input type="datetime-local" name="start_datetime" value="{{ old('start_datetime', $room->start_datetime->format('Y-m-d\TH:i')) }}" class="w-full bg-gray-50 border border-gray-200 text-gray-900 text-sm rounded-xl focus:ring-emerald-500 focus:border-emerald-500 block px-4 py-3.5 transition font-medium" required>
                        </div>

                        <div>
                            <label class="block text-sm font-bold text-gray-700 mb-2">Maks. Peserta</label>
                            <div class="relative">
                                <input type="number" name="max_participants" value="{{ old('max_participants', $room->max_participants) }}" class="w-full bg-gray-50 border border-gray-200 text-gray-900 text-sm rounded-xl focus:ring-emerald-500 focus:border-emerald-500 block px-4 py-3.5 transition font-bold text-center">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" step="1000" name="cost_per_person" value="{{ old('cost_per_person', $room->cost_per_person) }}" class="w-full bg-gray-50 border border-gray-200 text-gray-900 text-sm rounded-xl focus:ring-emerald-500 focus:border-emerald-500 block pl-12 pr-4 py-3.5 transition font-bold">
                            </div>
