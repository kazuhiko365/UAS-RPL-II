...
<body>
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <h2 style="margin: 0 0 10px 0; color: #111827;">Halo {{ $participant->user->name }}!</h2>
            ...
            <div class="card">
                ...
                <div class="card-row">
                    ...
                    <div class="value">{{ $participant->room->title }}</div>
                </div>
                <div class="card-row">
                    <div class="label">Waktu</div>
                    <div class="value">{{ $participant->room->start_datetime->format('d M Y, H:i') }} WIB</div>
                </div>
                <div class="card-row">
                    <div class="label">Lokasi</div>
                    <div class="value">{{ $participant->room->venue->name }}</div>
                </div>
                <div class="card-row">
                    <div class="label">Biaya</div>
                    <div class="value">Rp {{ number_format($participant->room->cost_per_person, 0, ',', '.') }} / orang
                    </div>
                </div>
            </div>
