...
<body>
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="info-box">
                <div class="info-item">
                    <strong>👤 Peserta:</strong> {{ $participant->user->name }}
                </div>
                <div class="info-item">
                    <strong>🏆 Room:</strong> {{ $participant->room->title }}
                </div>
                <div class="info-item">
                    <strong>📅 Jadwal:</strong> {{ $participant->room->start_datetime->format('d M Y, H:i') }} WIB
                </div>
            </div>
            ...
            <a href="{{ $urlConfirm }}" class="btn">
                ✅ Terima Peserta Ini
            </a>

            <p style="margin-top: 30px; font-size: 14px; text-align: center;">
                Ingin cek profilnya dulu?
                <a href="{{ route('rooms.show', $participant->room->id) }}" class="link-secondary">Lihat Detail Room</a>
            </p>
        </div>
